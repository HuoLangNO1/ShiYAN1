...
public class MainActivity extends AppCompatActivity implements View.OnClickListener{
    Button btn_0,btn_1,btn_2,btn_3,btn_4,btn_5,btn_6,   //布局控件
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()){
            case R.id.btn_del:
                if(str.length()>1){
                    str=str.substring(0,str.length()-1);//递减删除
                }
                else{
                    str="0";
                }
            ...
            case R.id.btn_clear:
                str="0";
                text.setText(str);//全删除
                break;
            case R.id.btn_0:
                if (str.equals("0")){
                    str="0";
                }else if(str.charAt(str.length()-1)==')'){ //右括号右侧不能为数字
            ...
            case R.id.btn_p: //小数点判断格式
                if(str.charAt(str.length()-1)=='+'||str.charAt(str.length()-1)=='-'||str.charAt(str.length()-1)=='×'||str.charAt(str.length()-1)=='÷'||str.charAt(str.length()-1)=='.'){
                    Toast.makeText(MainActivity.this,"Input error!",Toast.LENGTH_SHORT).show();
                    text.setText(str);
                }else{//判断是否出现同一数字多个小数点的情况
                    int i=str.length()-1;
                    char a0=str.charAt(i);
                    while(a0<='9'&&a0>='0'){
                        if ((i-1)>=0) {
                            a0=str.charAt(--i);
                            continue;
                    ...
                    if (a0=='.'){
                        Toast.makeText(MainActivity.this,"Decimal point Error!",Toast.LENGTH_SHORT).show();
                        text.setText(str);
                    }else {
                        str += ".";
                        text.setText(str);
                ...
                break;
            case R.id.btn_add://加法运算判断左侧是否为其他运算符号
                if(str.charAt(str.length()-1)=='+'||str.charAt(str.length()-1)=='-'||str.charAt(str.length()-1)=='×'||str.charAt(str.length()-1)=='÷'||str.charAt(str.length()-1)=='.'){
                    Toast.makeText(MainActivity.this,"Input error!",Toast.LENGTH_SHORT).show();
                    text.setText(str);
                }
            ...
            case R.id.btn_leftbra:
                if (str.length()==1){//若原始字符串为1，即一个数字，则将左括号提至最前方
                    str="(";
                }else if(!str.contains("+")&&!str.contains("-")&&!str.contains("×")&&!str.contains("÷")){//左括号不包含运算符号时，默认将括号提至左侧
                    str="("+str;
                }else if(str.charAt(str.length()-1)>='0'&&str.charAt(str.length()-1)<='9'){//左括号作为不可为数字
                    Toast.makeText(MainActivity.this,"Leftbra error!",Toast.LENGTH_SHORT).show();
                }else {
                    str += "(";
                }
                text.setText(str);
